...
export default {
  ...
  methods: {
    Register() {
      ...
      // this.name = document.getElementById("register_name").value,
      // this.email = document.getElementById("register_email").value;
      // this.password = document.getElementById("register_password").value;
    },
  },
};
</script>
...
<template>
  <section class="register">
    <fieldset>
      <form class="form_container" id="formRegister">
        ...
        <div class="input_container">
          <label class="input_label" for="register_name">Name</label>
          <svg
            height="24"
            width="24"
        ...
        <div class="input_container">
          <label class="input_label" for="register_email">Email</label>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="24"
        ...
        <div class="input_container">
          <label class="input_label" for="register_password">Password</label>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="24"
        ...
        <button type="submit" class="sign-in_btn" @click="Register">
