...
<template>
  <section class="login">
    <fieldset>
      <form class="form_container" id="formLogin" onsubmit="Auth.login(event)">
        ...
        <div class="input_container">
          <label class="input_label" for="login_password">Password</label>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="24"
        ...
        <button type="submit" class="sign-in_btn" @keypress.enter="Login">
          <span>Sign In</span>
        </button>
        <div class="separator">
          <hr class="line" />
